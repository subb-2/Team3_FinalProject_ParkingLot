...
#   "A-3"    (4, 0)            (  0.0,  70.0)  일반       5
#   "A-4"    (5, 0)            (  0.0,  87.5)  일반       4
#   "A-5"    (7, 0)            (  0.0, 122.5)  장애인     1
#   "B-1"    (3, 4)            ( 40.0,  52.5)  전기차     4
#   "B-2"    (4, 4)            ( 40.0,  70.0)  전기차     2
#   "C-1"    (3, 7)            ( 70.0,  52.5)  전기차     3
#   "C-2"    (4, 7)            ( 70.0,  70.0)  전기차     1
#   "D-1"    (1,11)+(2,11)     (110.0,  26.2)  대형       1   <- 2칸이 1자리
#   "D-2"    (4,11)            (110.0,  70.0)  일반       3
#   "D-3"    (5,11)            (110.0,  87.5)  일반       2
#   "D-4"    (7,11)            (110.0, 122.5)  일반       1
#
#   배정순위 = 같은 종류 안에서 빈자리를 고르는 순서 (map_data.SPOT_PRIORITY)
#   입구 GATE1 = 격자(8, 8) = (80.0, 140.0)cm  /  출구 GATE2 = 격자(8, 3)
#
#   격자 그림 (A=왼쪽열 c0, B=중앙섬 c4, C=중앙섬 c7, D=오른쪽열 c11)
#         c0    c4    c7   c11
#    r1  A-1               D-1 ┐ 대형 1자리
#    r2  A-2               D-1 ┘
#    r3        B-1   C-1
