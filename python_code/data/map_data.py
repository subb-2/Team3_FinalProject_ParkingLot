...
#
# 아래 배정은 '왼쪽 열 -> 중앙 섬 -> 오른쪽 열, 각 열은 위에서 아래로' 순서로
# 매긴 기본값이다. 실제 목업과 다르면 여기를 고칠 것.
# (틀리면 호모그래피 재투영 오차가 커지거나 아예 안 잡힌다)
#
#   왼쪽 열(col 0)   중앙 섬(col 4)   중앙 섬(col 7)   오른쪽 열(col 11)
#     row 0 : id1      row 2 : id4      row 2 : id6      row 0 : id8
#     row 3 : id2      row 5 : id5      row 5 : id7      row 3 : id9
#     row 6 : id3                                        row 6 : id10
PILL_MARKER_ID = {
    (0, 0): 1,  (3, 0): 2,  (6, 0): 3,
    (2, 4): 4,  (5, 4): 5,
    (2, 7): 6,  (5, 7): 7,
...
# 시작부터 차가 세워져 있는 상황을 테스트하려면 INITIAL_OCCUPIED에 적을 것.
#
#   INITIAL_OCCUPIED = {"A-1": "full", "D-2": "full"}
#
